...
<div class="nav-buttons">
    ...
    <g:link action="show" id="${this.warehouse?.id}" class="btn btn-secondary">View</g:link>
</div>
...
<div style="background:white;padding:24px;border-radius:8px;box-shadow:0 2px 8px rgba(0,0,0,0.08);max-width:500px;">
    <g:form resource="${this.warehouse}" controller="warehouse" method="PUT">
        ...
        <div style="margin-bottom:14px;">
            <label style="display:block;margin-bottom:4px;font-weight:bold;">Max Capacity *</label>
        ...
        <div style="margin-bottom:20px;">
            <label style="display:block;margin-bottom:4px;font-weight:bold;">Current Load *</label>
            <g:field type="number" name="currentLoad" value="${this.warehouse?.currentLoad}" min="0" style="width:100%;padding:8px;border:1px solid #ccc;border-radius:4px;"/>
        </div>
