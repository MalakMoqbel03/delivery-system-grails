class UrlMappings {
    ...
    static mappings = {
        "/bulkLocation"(controller: 'bulkLocation', action: 'index', method: 'GET')
        "/bulkLocation/importCsv"(controller: 'bulkLocation', action: 'importCsv', method: 'POST')
        "/bulkLocation/exportExcel"(controller: 'bulkLocation', action: 'exportExcel', method: 'GET')
        "/bulkLocation/importAndExport"(controller: 'bulkLocation', action: 'importAndExport', method: 'POST')
        "/login"(controller: 'auth')  { action = [GET: 'login', POST: 'doLogin'] }
        "/logout"(controller: 'auth', action: 'logout')
        "/forbidden"(controller: 'auth', action: 'forbidden')
        "/auth/userView"(controller: 'auth', action: 'userView', method: 'GET')
        "/"(controller: 'auth')       { action = [GET: 'login', POST: 'doLogin'] }
